    ...
    response = anthropic_client.messages.create(
        ...
        messages=[{
            ...
            "content": (
                ...
                "Shiva Sutras (Vasugupta), Spanda Karikas, Pratyabhijna Hridayam (Kshemaraja), "
                "Vijnana Bhairava Tantra, Tantrasara (Abhinavagupta), Paratrishika Vivarana, "
                "Kashmir Shaivism: The Secret Supreme (Swami Lakshman Joo), "
                "Lalla Vakyani / I Lalla (Lal Ded), Panchastavi (Gopi Krishna), "
                "or Krama Naya Deepika — pick one of the most profound, beautiful, "
                "and widely-cited verses or quotes in English. "
                ...
                "the non-dual awareness, or the mystical poetry of Lal Ded. "
